    ...
    <script>
        ...
        function montarTextoCopiar(q) {
            const linhas = [
                ...
                '',
                `Tipo: ${limparTexto(q.tipo || 'dissertativa')}`,
            ...
            const respostaEsperada = q.explicacao ? limparTexto(q.explicacao) : 'Resposta do aluno.';
            linhas.push(respostaEsperada);
        ...
        async function montarHTMLCopiar(q) {
            ...
            return `
                <article style="font-family:Arial,sans-serif;color:#222;line-height:1.5;">
                    ...
                    <p style="margin:0 0 4px;"><strong>Tipo:</strong> Dissertativa</p>
                    ...
                    <h2 style="font-size:16px;margin:16px 0 6px;">Resposta esperada</h2>
                    <div>${q.explicacao ? limparHTMLBasico(q.explicacao) : 'Resposta do aluno.'}</div>
                </article>
            `;
        }
